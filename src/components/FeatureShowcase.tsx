...
export function FeatureShowcase() {
    ...
    return (
        <section ref={containerRef} className="relative bg-[var(--color-bg)]">
            ...
            <div className="relative min-h-[90vh] py-20 lg:py-0 lg:sticky lg:top-0 lg:h-screen flex items-center overflow-hidden border-b lg:border-none border-[var(--color-border-subtle)]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center w-full">
                        ...
                        <div className="lg:col-span-2 space-y-6 md:space-y-8 text-center lg:text-left">
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true, margin: "-10%" }}
                                className="text-lg md:text-xl text-[var(--color-text-secondary)] leading-relaxed max-w-md mx-auto lg:mx-0"
                            >
            ...
            {/* Feature 2: Search */}
            <div className="relative min-h-[90vh] py-20 lg:py-0 lg:sticky lg:top-0 lg:h-screen flex items-center overflow-hidden border-t border-[var(--color-border-subtle)] lg:border-t-0">
                <div className="absolute inset-0 bg-[var(--color-bg-elevated)]/90 backdrop-blur-xl">
            ...
            <div className="relative min-h-[90vh] py-20 lg:py-0 lg:sticky lg:top-0 lg:h-screen flex items-center overflow-hidden border-t border-[var(--color-border-subtle)] lg:border-t-0">
                ...
                <div className="relative max-w-7xl mx-auto px-6 w-full h-full flex items-center">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center w-full">
                        ...
                        {/* Left mockup - Order fixed for mobile */}
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95, y: 60, filter: "blur(20px)" }}
                            whileInView={{ opacity: 1, scale: 1, y: 0, filter: "blur(0px)" }}
                            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
                        ...
                        {/* Right content */}
                        <div className="lg:col-span-2 space-y-6 md:space-y-8 text-center lg:text-left order-1 lg:order-2">
                            <motion.div
                                initial={{ opacity: 0, y: 40, filter: "blur(20px)" }}
                                whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }}
                                transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
            ...
            <div className="relative min-h-[50vh] py-20 lg:py-0 lg:sticky lg:top-0 lg:h-screen flex items-center justify-center overflow-hidden bg-[var(--color-bg-elevated)]/90 backdrop-blur-xl border-t border-[var(--color-border-subtle)]">
                <div className="relative z-10 text-center px-6">
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-10%" }}
                    >
                        <h3 className="text-4xl md:text-7xl font-bold text-[var(--color-text-primary)] mb-8 tracking-tighter leading-tight max-w-4xl mx-auto">
                            This tool is for people who <br />
                            <span className="text-[var(--color-text-secondary)]">hate themselves a little less.</span>
                        </h3>
                        <p className="text-lg md:text-xl text-[var(--color-text-secondary)] mb-12 max-w-xl mx-auto">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[800px] h-[300px] md:h-[800px] bg-white/5 dark:bg-white/5 rounded-full blur-[120px] animate-pulse" />
                </div>
            </div>
        </section>
    );
